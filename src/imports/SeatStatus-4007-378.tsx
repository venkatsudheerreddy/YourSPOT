import svgPaths from "./svg-zhguclvkwg";
...
function Seats() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[24px] top-[49px]" data-name="Seats">
...
function Seats1() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[24px] top-[137px]" data-name="Seats">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1b1b23] text-[14px] text-center text-nowrap">S-01</p>
      <div className="bg-[#9961f7] h-[80px] rounded-[4px] shadow-[0px_2px_12px_0px_rgba(153,97,247,0.5)] shrink-0 w-[40px]" data-name="Desk" />
      <Chair1 />
    </div>
  );
}
...
function Seats2() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[24px] top-[225px]" data-name="Seats">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1b1b23] text-[14px] text-center text-nowrap">S-01</p>
