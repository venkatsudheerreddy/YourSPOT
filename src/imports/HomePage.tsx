import svgPaths from "./svg-i9u7fk38f8";
...
export default function HomePage() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-center justify-between relative size-full" data-name="Home page">
      <Header />
      <MainContent />
    </div>
  );
