import svgPaths from "./svg-m6wcghpbaf";

function SeatNumber() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[40px]" data-name="Seat number">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1b1b23] text-[14px] text-center text-nowrap">105</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[40px]" data-name="Seat number">
      <div className="flex h-[24px] items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "23.359375", "--transform-inner-height": "16" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg] w-full">
          <p className="font-['Poppins:SemiBold',sans-serif] h-[40px] leading-[normal] not-italic relative text-[#1b1b23] text-[14px] text-center w-full">104</p>
        </div>
      </div>
    </div>
  );
...
function Seat8() {
  return (
    <div className="content-stretch flex items-center pb-[16px] pl-0 pr-[40px] pt-0 relative shrink-0" data-name="Seat 8">
      <div className="flex h-[116px] items-center justify-center relative shrink-0 w-[64px]" style={{ "--transform-inner-width": "23.359375", "--transform-inner-height": "16" } as React.CSSProperties}>
...
export default function SeatLayout2() {
  return (
