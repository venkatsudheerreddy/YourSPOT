import svgPaths from "./svg-ckdw7itoy2";
...
export default function ZoneD() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center relative size-full" data-name="Zone D">
      <SeatLayout1 />
    </div>
  );
}