import svgPaths from "./svg-79gt5hzkqz";
...
export default function DirectionLayoout() {
  return (
    <div className="bg-white relative size-full" data-name="Direction layoout">
      ...
      <div className="absolute h-[169px] left-[390px] top-[316px] w-[24px]" data-name="Path line">
        <div className="absolute inset-[-0.89%_-6.25%]" style={{ "--stroke-0": "rgba(153, 97, 247, 1)" } as React.CSSProperties}>
