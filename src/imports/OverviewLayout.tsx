import svgPaths from "./svg-a6nxvudu7m";
...
function Frame8() {
  return (
    <div className="bg-[#9961f7] h-[64px] relative rounded-[4px] shrink-0 w-[32px]">
      <div className="absolute flex h-[42px] items-center justify-center left-[calc(50%-0.5px)] top-[calc(50%-21px)] translate-x-[-50%] w-[15px]" style={{ "--transform-inner-width": "37.8125", "--transform-inner-height": "11.1875" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative text-[10px] text-center text-nowrap text-white">Sudheer</p>
        </div>
      </div>
    </div>
  );
...
function BookSeat1() {
  return (
    <div className="[grid-area:1_/_1] content-stretch flex flex-col items-start justify-center ml-[4px] mt-[5px] relative" data-name="Book seat 2">
      <Frame6 />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="bg-[#ff8c44] h-[64px] relative rounded-[4px] shrink-0 w-[32px]">
      <div className="absolute flex h-[42px] items-center justify-center left-[calc(50%-0.5px)] top-[calc(50%-21px)] translate-x-[-50%] w-[15px]" style={{ "--transform-inner-width": "37.8125", "--transform-inner-height": "11.1875" } as React.CSSProperties}>
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <div className="bg-[#d3d5da] rounded-[4px] shrink-0 size-[16px]" data-name="Seat" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#464a53] text-[12px] text-nowrap">Available</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <div className="bg-[#9961f7] rounded-[4px] shrink-0 size-[16px]" data-name="Seat" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#464a53] text-[12px] text-nowrap">Occupied</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <div className="bg-[#ff8c44] rounded-[4px] shrink-0 size-[16px]" data-name="Seat" />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#464a53] text-[12px] text-nowrap">My seat</p>
    </div>
  );
}
...
export default function OverviewLayout() {
  return (
    <div className="bg-white relative size-full" data-name="Overview layout">
