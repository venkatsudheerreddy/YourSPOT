import svgPaths from "./svg-acknh7l33g";
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1b1b23] text-[22px] text-nowrap">S-01</p>
...
function NextBooking() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="Next booking">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[20px] relative w-full">
          <Icon />
          <Details />
        </div>
      </div>
