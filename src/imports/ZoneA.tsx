import svgPaths from "./svg-92y3s346z9";
...
export default function ZoneA() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center relative size-full" data-name="Zone A">
      <SeatLayout1 />
    </div>
  );
}