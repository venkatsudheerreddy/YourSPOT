import svgPaths from "./svg-uhdlkqngvv";

function Header() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center not-italic opacity-90 overflow-clip px-0 py-[40px] relative shrink-0 text-nowrap text-white w-[390px]" data-name="Header">
...
function TodaysOverview() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center px-0 py-[24px] relative shrink-0 w-[390px]" data-name="Today\'s overview">
...
function Actions() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] h-[553px] items-center px-[16px] py-[24px] relative rounded-tl-[24px] rounded-tr-[24px] shrink-0 w-[390px]" data-name="Actions">
      <NextBooking />
...
function MainContainer() {
  return (
    <div className="absolute bg-gradient-to-b content-stretch flex flex-col from-[#9961f7] h-[844px] items-start left-0 to-[#622ac2] top-0 w-[390px]" data-name="Main container">
      <Header />
      <div className="bg-gradient-to-r from-[rgba(255,255,255,0)] h-px opacity-40 shrink-0 to-[rgba(255,255,255,0)] via-[#ffffff] via-[47.596%] w-full" data-name="Divider" />
      <TodaysOverview />
      <Actions />
        ...
        <div className="basis-0 content-stretch flex flex-col grow h-[64px] items-center justify-center min-h-px min-w-px relative shrink-0" data-name="home">
          <div className="relative shrink-0 size-[20px]" data-name="home">
            <div className="absolute inset-[-34.36%_-45.83%_-57.92%_-45.83%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38.333 38.4551">
                <g id="home">
                  <g filter="url(#filter0_d_18141_159)" id="Subtract">
                    <path d={svgPaths.p23434ec0} fill="var(--fill-0, #9961F7)" />
                  </g>
                </g>
                <defs>
                  <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="38.4551" id="filter0_d_18141_159" width="38.333" x="0" y="0">
                    ...
                    <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_18141_159" />
                    <feBlend in="SourceGraphic" in2="effect1_dropShadow_18141_159" mode="normal" result="shape" />
                  </filter>
                </defs>
              </svg>
            </div>
