import svgPaths from "./svg-h3891ienzq";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Layout">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Layout">
          <g id="Vector">
            <path d={svgPaths.p1eac000} stroke="var(--stroke-0, #1B1B23)" strokeLinejoin="round" />
            <path d={svgPaths.p325be000} stroke="var(--stroke-0, #1B1B23)" strokeLinejoin="round" />
            <path d={svgPaths.p17868e00} stroke="var(--stroke-0, #1B1B23)" strokeLinejoin="round" />
            <path d={svgPaths.p1ccdb000} stroke="var(--stroke-0, #1B1B23)" strokeLinejoin="round" />
          </g>
        </g>
      </svg>
    </div>
...
function Available1() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0" data-name="Available">
      <Layout />
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#545864] text-[12px] text-nowrap">layout</p>
    </div>
  );
}
