import svgPaths from "./svg-z0w2ahuhk";
...
export default function ZoneC() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center relative size-full" data-name="Zone C">
      <SeatLayout1 />
    </div>
  );
}