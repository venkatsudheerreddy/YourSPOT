import svgPaths from "./svg-qs96r8699n";
...
function PaginationDots() {
  return (
    <div className="absolute bottom-[16px] h-[22px] left-1/2 translate-x-[-50%] w-[62px]" data-name="Pagination Dots">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62 22">
        <g id="Pagination Dots">
          <circle cx="11" cy="11" fill="var(--fill-0, black)" id="Item 1" opacity="0.2" r="3" />
          <circle cx="21" cy="11" fill="var(--fill-0, black)" id="Item 2" r="3" />
          <circle cx="31" cy="11" fill="var(--fill-0, black)" id="Item 3" opacity="0.2" r="3" />
          <circle cx="41" cy="11" fill="var(--fill-0, black)" id="Item 4" opacity="0.2" r="3" />
          <circle cx="51" cy="11" fill="var(--fill-0, black)" id="Item 5" opacity="0.2" r="3" />
        </g>
      </svg>
    </div>
  );
