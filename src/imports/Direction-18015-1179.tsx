import svgPaths from "./svg-mr4ubspf5s";
...
function IconButton1() {
  return (
    <div className="bg-secondary opacity-0 relative rounded-[999px] shrink-0 size-[40px]" data-name="Icon button">
      <div aria-hidden="true" className="absolute border border-input border-solid inset-0 pointer-events-none rounded-[999px] shadow-[0px_2px_12px_0px_rgba(153,97,247,0.5)]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[16px] py-[56px] relative size-full">
          <Dismiss1 />
        </div>
...
function TopAppBar() {
  return (
    <div className="bg-card h-[72px] opacity-90 relative shadow-[0px_4px_28px_0px_rgba(138,56,245,0.2)] shrink-0 w-full z-[2]" data-name="Top app bar">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[16px] py-[56px] relative size-full">
          <IconButton />
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[20px]">
      <p className="font-[family-name:var(--font-primary)] font-[weight:var(--fw-heavy)] leading-[normal] not-italic relative shrink-0 text-secondary-foreground text-[10px] text-center w-full">105</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[20px]">
      <p className="font-[family-name:var(--font-primary)] font-[weight:var(--fw-heavy)] leading-[normal] not-italic relative shrink-0 text-secondary-foreground text-[10px] w-full">101</p>
    </div>
  );
}
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] h-0 ml-0 mt-[320px] relative w-[168px]" data-name="Corridor">
        <div className="absolute inset-[-26px_-7.14%_-14px_-7.14%]" style={{ "--stroke-0": "rgba(153, 97, 247, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 192 40">
            <g filter="url(#filter0_d_18015_890)" id="Corridor">
              <line stroke="var(--stroke-0, var(--primary))" strokeLinecap="round" strokeWidth="16" x1="20" x2="172" y1="18" y2="18" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="40" id="filter0_d_18015_890" width="192" x="0" y="0">
                ...
                <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_18015_890" />
                <feBlend in="SourceGraphic" in2="effect1_dropShadow_18015_890" mode="normal" result="shape" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <div className="[grid-area:1_/_1] h-[169px] ml-[85px] mt-[144.5px] relative w-[25.5px]" data-name="Path">
        <div className="absolute inset-[-0.89%_-5.88%]" style={{ "--stroke-0": "rgba(0, 81, 152, 1)" } as React.CSSProperties}>
