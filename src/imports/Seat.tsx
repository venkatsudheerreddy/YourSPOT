import svgPaths from "./svg-fr3go00mvj";
...
function Tabs() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-center justify-center min-h-px min-w-px pb-0 pt-[16px] px-0 relative shrink-0" data-name="Tabs">
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1b1b23] text-[14px] text-nowrap">Zone 1</p>
...
function Tabs1() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-center justify-center min-h-px min-w-px pb-0 pt-[16px] px-0 relative shrink-0" data-name="Tabs">
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#9961f7] text-[14px] text-nowrap">Zone 2</p>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-12px_-9.23%_-14px_-9.23%]" style={{ "--stroke-0": "rgba(153, 97, 247, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 154 26">
            <g filter="url(#filter0_d_4005_1224)" id="Line 12">
              <line stroke="var(--stroke-0, #9961F7)" strokeWidth="2" x1="12" x2="142" y1="11" y2="11" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="26" id="filter0_d_4005_1224" width="154" x="0" y="0">
                ...
                <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_4005_1224" />
                <feBlend in="SourceGraphic" in2="effect1_dropShadow_4005_1224" mode="normal" result="shape" />
              </filter>
            </defs>
          </svg>
        </div>
...
function Tabs2() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-center justify-center min-h-px min-w-px pb-0 pt-[16px] px-0 relative shrink-0" data-name="Tabs">
      <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1b1b23] text-[14px] text-nowrap">Zone 3</p>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]" style={{ "--stroke-0": "rgba(211, 213, 218, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 130 1">
            <line id="Line 12" stroke="var(--stroke-0, #D3D5DA)" x2="130" y1="0.5" y2="0.5" />
