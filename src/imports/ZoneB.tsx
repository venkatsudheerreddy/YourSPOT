import svgPaths from "./svg-eg369d6cq5";
...
export default function ZoneB() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center relative size-full" data-name="Zone B">
      <SeatLayout1 />
    </div>
  );
}